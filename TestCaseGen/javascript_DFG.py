...
def DFG_generation(code):
    openai_key = "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"
    message = [{"role": "system"}]
    with open("./prompt_examples/DFG_js.txt", "r", encoding="utf-8") as f:
        message[0]["content"] = f.read()
    #read the csv file
    df = pd.read_csv("prompt_examples/js_example.csv")
